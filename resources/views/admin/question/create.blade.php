                                ...
                                @csrf
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"  name="text" class="form-control" id="exampleInputName"
                                                   placeholder="Enter Question text">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Question Percentage</label>
                                            <input type="number"  name="percentage" class="form-control" id="exampleInputEmail1"
                                                   placeholder="Enter Question percentage">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Question Order</label>
                                            <input type="number" name="order" class="form-control" id="exampleInputPassword1"
