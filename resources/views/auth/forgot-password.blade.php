...
{{-- 
 <head>
    ...
    <title>:: Internal Example :: Forget  Password</title>
    <!-- Favicon-->
        ...
        <div class="row">
           ...
           <a href="javascript:void(0);" class="link">Need Help?</a> --}}
                ...
                <div class="copyright text-center">
                    ...
                    <span>Designed by <a href="#" target="_blank">Internal Example</a></span>
                </div>
            </div>
...
<head>
  ...
  <title>Internal Example | Forgot Password (v2)</title>
...
<div class="login-box">
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="../../index2.html" class="h1"><b>Internal </b>Example</a>
    </div>
    <div class="card-body">
