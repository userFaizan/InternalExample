...
<head>
    ...
    <title>:: Internal Example :: Sign In</title>
    <!-- Favicon-->
            ...
            <div class="col-lg-4 col-sm-12">
                ...
                <form method="POST" action="{{ route('login') }}" class="card auth_form">
                    ...
                    <div class="body">
                        ...
                        <button type="submit"
                                class="btn btn-primary btn-block waves-effect waves-light">SIGN IN
                        </button>
                                                <div class="signin_with mt-3">
                        <p class="mb-0 text-center">or <a href="{{route('register')}}">Sign Up</a></p>
                        <span class="input-group-text"><a href="{{route('password.request')}}" class="forgot" title="Forgot Password"><i
                                    class="zmdi zmdi-lock"></i></a></span>
